...
# Some default ATfE settings ATfE must be part of path environment Windows
if(WIN32)
  set(TOOLCHAIN_PREFIX
      "D:/Arm_ToolChain/ATfE-20.1.0-Windows-x86_64/bin"
      CACHE PATH "Path to the toolchain prefix")
...
elseif(UNIX)
  set(TOOLCHAIN_PREFIX
      "/home/JontyLi/Dev/ATfE-20.1.0-Linux-x86_64/bin"
      CACHE PATH "Path to the toolchain prefix")
...
# MCU specific flags
set(TARGET_FLAGS
    "--target=armv7m-none-eabi -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb")
...
set(CMAKE_C_LINK_FLAGS
    "${CMAKE_C_LINK_FLAGS} -T \"${CMAKE_SOURCE_DIR}/STM32H743XX_FLASH.ld\"")
...
set(CMAKE_C_LINK_FLAGS
    "${CMAKE_C_LINK_FLAGS} -Wl,--start-group -Wl,--end-group")
