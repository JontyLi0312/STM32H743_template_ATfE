...
#define LVGL_MemoryAdd                                                         \
    (LCD_MemoryAdd + LCD_Width * LCD_Height * BytesPerPixel_0) // 显示缓冲区地址
...
void lv_port_disp_init(void)
{
    ...
    //		lv_disp_draw_buf_init(&draw_buf_dsc_2, buf_2_1, buf_2_2, LCD_Width *
    // 100);   /*Initialize the display buffer*/

    /* Example for 3) also set disp_drv.full_refresh = 1 below*/
    static lv_disp_draw_buf_t draw_buf_dsc_3;
    static lv_color_t *buf_3_1 =
        (lv_color_t *)(LVGL_MemoryAdd); /*A screen sized buffer*/
    static lv_color_t *buf_3_2 =
        (lv_color_t *)(LVGL_MemoryAdd +
                       LCD_Width * LCD_Height *
                           sizeof(lv_color_t)); /*Another screen sized buffer*/
    lv_disp_draw_buf_init(&draw_buf_dsc_3, buf_3_1, buf_3_2,
                          LCD_Width *
                              LCD_Height); /*Initialize the display buffer*/
