...
#define GPIO_QUADSPI_CLK_ENABLE                                                \
    __HAL_RCC_GPIOB_CLK_ENABLE() // QUADSPI_CLK 引脚时钟
...
#define GPIO_QUADSPI_BK1_NCS_ENABLE                                            \
    __HAL_RCC_GPIOB_CLK_ENABLE() // QUADSPI_BK1_NCS 引脚时钟
...
#define GPIO_QUADSPI_BK1_IO0_ENABLE                                            \
    __HAL_RCC_GPIOD_CLK_ENABLE() // QUADSPI_BK1_IO0 引脚时钟
...
#define GPIO_QUADSPI_BK1_IO1_ENABLE                                            \
    __HAL_RCC_GPIOD_CLK_ENABLE() // QUADSPI_BK1_IO1 引脚时钟
...
#define GPIO_QUADSPI_BK1_IO2_ENABLE                                            \
    __HAL_RCC_GPIOE_CLK_ENABLE() // QUADSPI_BK1_IO2 引脚时钟
...
#define GPIO_QUADSPI_BK1_IO3_ENABLE                                            \
    __HAL_RCC_GPIOD_CLK_ENABLE() // QUADSPI_BK1_IO3 引脚时钟
...
int8_t QSPI_W25Qxx_WriteBuffer(
    uint8_t *pData, uint32_t WriteAddr,
    uint32_t Size); // 写入数据，最大不能超过flash芯片的大小
int8_t QSPI_W25Qxx_ReadBuffer(
